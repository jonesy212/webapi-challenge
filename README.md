...
- [X] Describe Middleware?
    Middleware is helps filter commands/requests for security.  It is a way to add extra parameters for verification.

- [X] Describe a Resource?
    It is any identifiable thing.  It is the information pertaining to the business that the client can access and bring back to the requestor.

- [X] What can the API return to help clients know if a request was successful?
    It can bring back a HTTP Response Status Codes.

- [X] How can we partition our application into sub-applications?
    We can do so with Express
